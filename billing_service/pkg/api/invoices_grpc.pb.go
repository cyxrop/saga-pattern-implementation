...
type InvoiceServiceClient interface {
	Get(ctx context.Context, in *ID, opts ...grpc.CallOption) (*InvoiceResponse, error)
}
...
func (c *invoiceServiceClient) Get(ctx context.Context, in *ID, opts ...grpc.CallOption) (*InvoiceResponse, error) {
	out := new(InvoiceResponse)
	err := c.cc.Invoke(ctx, "/api.InvoiceService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InvoiceServiceServer interface {
	Get(context.Context, *ID) (*InvoiceResponse, error)
...
func (UnimplementedInvoiceServiceServer) Get(context.Context, *ID) (*InvoiceResponse, error) {
...
func _InvoiceService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.InvoiceService/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InvoiceServiceServer).Get(ctx, req.(*ID))
	}
...
var InvoiceService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.InvoiceService",
